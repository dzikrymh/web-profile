...
<html lang="en">
<head>
	<title>CV - Dzikry Maulana Hakim</title>
				...
				<div class="row">
					<div class="col-sm-6 col-md-6 col-lg-4">
						<div class="info">
							...
							<div class="right-area">
								<h5>Sekemirung Kaler No.26B, RT06/RW09</h5>
								<h5>Kel. Cigadung, Kec. Cibeunying Kaler</h5>
								<h5>Bandung, Jawa Barat, 40191</h5>
							</div><!-- right-area -->
						</div><!-- info -->
					</div><!-- col-sm-4 -->
					...
					<div class="col-sm-6 col-md-6 col-lg-4">
						<div class="info">
							...
							<div class="right-area">
								<h5>dzikry.maulana.hakim@gmail.com</h5>
			...
			<div class="row">
				...
				<div class="col-md-10 col-lg-8">
					<div class="intro">
						...
						<h2><b>Dzikry Maulana Hakim</b></h2>
						<h4 class="font-yellow">Android Developer</h4>
						<ul class="information margin-tb-30">
							<li><b>BORN : </b>August 20, 1996</li>
							<li><b>EMAIL : </b>dzikry.maulana.hakim@gmail.com</li>
							<li><b>MARITAL STATUS : </b>Single</li>
						</ul>
						<ul class="social-icons">
							<li><a href="https://www.pinterest.com/dzikrymh" target="_blank"><i class="ion-social-pinterest"></i></a></li>
							<li><a href="https://www.linkedin.com/in/dzikry-maulana-hakim-3268a4162" target="_blank"><i class="ion-social-linkedin"></i></a></li>
							<li><a href="https://www.instagram.com/dzikrymh" target="_blank"><i class="ion-social-instagram"></i></a></li>
							<li><a href="https://www.facebook.com/dzikry.maulana" target="_blank"><i class="ion-social-facebook"></i></a></li>
							<li><a href="https://twitter.com/dzikrymh" target="_blank"><i class="ion-social-twitter"></i></a></li>
						</ul>
					</div><!-- intro -->
				</div><!-- col-sm-8 -->
			</div><!-- row -->
	...
	<section class="portfolio-section section">
			...
			<div class="row">
				...
				<div class="col-sm-8">
					<div class="portfolioFilter clearfix margin-b-80">
						...
						<a href="#" data-filter=".address"><b>ADDRESS</b></a>
					</div><!-- portfolioFilter -->
				</div><!-- col-sm-8 -->
			</div><!-- row -->
		</div><!-- container -->
		...
		<div class="portfolioContainer">
			...
			<div class="p-item address">
				<!-- <a class="img" href="images/portfolio-10-300x400.jpg" data-fluidbox> -->
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3961.047138003607!2d107.63034761405623!3d-6.884957295024881!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e707e89251ff%3A0xa50accbb9da93915!2sJl.%20Sekemirung%20Kaler%20No.26%2C%20Cigadung%2C%20Kec.%20Cibeunying%20Kaler%2C%20Kota%20Bandung%2C%20Jawa%20Barat%2040191!5e0!3m2!1sen!2sid!4v1606483818436!5m2!1sen!2sid" width="" height="" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
				<!-- </a> -->
					<!-- <button href="https://bale.my.id" class="btn btn-danger" onclick="return confirm('Apakah ilham ganteng ?')" data-fluidbox>Click Me!</button> -->
			</div><!-- p-item -->
